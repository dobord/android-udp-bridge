...
### 2.2 Client Manager
- [x] Создать `client_manager.h/c`
- [x] Реализовать таблицу клиентов
- [x] Добавить автоматическое присвоение client_id
- [x] Управление timeouts

### 2.3 Модификация UDP Listener
- [x] Изменить существующий UDP код
- [x] Добавить client identification
- [x] Интеграция с protocol handler

### 2.4 TCP Connection Manager
- [x] Модифицировать SSH туннель код
- [x] Добавить протокольную обертку
- [x] Реализовать reconnection logic
- [x] Обработка протокольных ответов

### 2.5 Java интерфейс
- [x] Создать `UdpBridgeConfig.java`
- [x] Модифицировать `UdpBridgeService.java`
- [x] Добавить UI для новых настроек
...
- [x] Развернуть server bridge в Docker
- [x] Провести базовые функциональные тесты
- [ ] Собрать и установить Android APK (требует Android SDK)
