...
our %config = (
    ...
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    "CXX" => "/opt/android-sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++",
    "CXXFLAGS" => [
        "-Wall -O3",
        "-fPIC"
    ],
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "/workspaces/android-udp-bridge/ssh-tunnel-android-app/app/src/main/prebuilt/openssl/arm64-v8a",
    "options" => "-D__ANDROID_API__=24 --prefix=/workspaces/android-udp-bridge/ssh-tunnel-android-app/app/src/main/prebuilt/openssl/arm64-v8a --openssldir=/workspaces/android-udp-bridge/ssh-tunnel-android-app/app/src/main/prebuilt/openssl/arm64-v8a -fPIC no-acvp-tests no-afalgeng no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-docs no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-jitter no-ktls no-loadereng no-md2 no-msan no-pie no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-sslkeylog no-tests no-tfo no-trace no-ubsan no-ui-console no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "0",
    ...
    "perlargv" => [
        "android-arm64",
        "-D__ANDROID_API__=24",
        "--prefix=/workspaces/android-udp-bridge/ssh-tunnel-android-app/app/src/main/prebuilt/openssl/arm64-v8a",
        "--openssldir=/workspaces/android-udp-bridge/ssh-tunnel-android-app/app/src/main/prebuilt/openssl/arm64-v8a",
        "no-shared",
        "no-tests",
        "no-ui-console",
    ...
    "perlenv" => {
        "AR" => "/opt/android-sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar",
        "BUILDFILE" => undef,
        "CC" => "/opt/android-sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang",
        "CFLAGS" => undef,
        "CPPFLAGS" => undef,
        "CROSS_COMPILE" => undef,
        "CXX" => "/opt/android-sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++",
        ...
        "PERL" => undef,
        "RANLIB" => "/opt/android-sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
        "RC" => undef,
        "RCFLAGS" => undef,
        "WINDRES" => undef,
        "__CNF_CFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/workspaces/android-udp-bridge/openssl_build/openssl/openssl-3.5.0/util/perl';
    use OpenSSL::fallback '/workspaces/android-udp-bridge/openssl_build/openssl/openssl-3.5.0/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/workspaces/android-udp-bridge/openssl_build/openssl/openssl-3.5.0/Configurations';
        use gentemplate;
