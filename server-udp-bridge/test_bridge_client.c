...
int create_message(
    char *buffer, size_t buffer_size, uint8_t msg_type, uint32_t client_id, const void *payload, uint32_t payload_size)
{
...
int main(int argc, char *argv[])
{
    ...
    msg_size = create_message(buffer, sizeof(buffer), MSG_DATA, client_id, test_data, strlen(test_data));
